...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     */
    @SuppressLint("NewApi") public PullToRefreshBase(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setHeaderLayout(LoadingLayout headerLayout) {
    	...
    	addHeaderAndFooter(headerLayout.getContext());
    	setGlobalLayoutListener();
    }
    ...
    protected void pullHeaderLayout(float delta) {
        ...
        if (isPullRefreshEnabled() && !isPullRefreshing()) { 
            if (scrollY > mHeaderHeight + (int)(getResources().getDisplayMetrics().density * 15)) {//多加点高度让下拉效果更好
