...
import com.cc.instrumentpanel.refresh.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
	...
	public static final int NORMAL_HEADER_LAYOUT = 1;
	public static final int REAL_HEADER_LAYOUT = 2;
    ...
    public void setHeaderLayoutType(int type){
    	if(type == REAL_HEADER_LAYOUT){
    		setHeaderLayout(new RealRotateLoadingLayout(mContext));
    	}else{
    		setHeaderLayout(new NormalRotateLoadingLayout(mContext));
    	}
    }
    
    @Override
    protected LoadingLayout createHeaderLoadingLayout(Context context, AttributeSet attrs) {
        return new RealRotateLoadingLayout(context);
    }
